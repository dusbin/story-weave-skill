...
/** 剧烈活动：体力消耗的判据 */
// 剧烈活动的词表。宁可宽一点：这条规则的判定是"未进食 + 剧烈活动"，word 漏了
// 就会整体漏报。实测漏过「健步如飞」——它是形容体力充沛的成语，必须收进来。
const EXERTION = /(马拉松|长跑|奔跑|狂奔|飞奔|跑|赶路|长途|跋涉|翻山|登山|爬|格斗|搏斗|战斗|打斗|厮杀|急行军|行军|劳作|干活|扛|背|搬运|追击|逃|奔袭|游泳|健步如飞|健步|箭步|大步流星|脚下生风|精神抖擞|毫不停歇|不停歇|连夜|硬撑|撑住|轻快|飞快|生龙活虎|力大无穷)/;
const DAY = 24;
const WEEK = 7 * DAY;
